...
import { FavoritesView } from "Users/FavoritesView";
			...
			router={createBrowserRouter([
				{
					...
					children: [
						...
						{ path: "/Favorites/:viewOptionsKey", element: <FavoritesView /> },
						...
						{ path: "/Studio/:studioId/:viewOptionsKey", element: <Studio /> },
						...
						{ path: "/Collection/:collectionId/:viewOptionsKey", element: <Collection /> },
