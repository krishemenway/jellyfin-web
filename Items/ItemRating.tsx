...
export const ItemRating: React.FC<{ item: BaseItemDto; libraryId: string; itemEditor?: EditableItem }&StyleLayoutProps> = (props) => {
	...
	if (isEditing && Nullable.HasValue(props.libraryId)) {
		return (
