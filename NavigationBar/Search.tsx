...
import Icon from "NavigationBar/SearchIcon";
...
const Search: React.FC = () => {
	...
	return (
		<Layout direction="row" alignItems="center" position="relative">
			<Icon className={searchStyles.searchIcon} size="20" />
			...
			<AnchoredModal
				...
				<Layout direction="column" className={background.panel} minHeight={300} minWidth={320} maxWidth={500}>
					<Loading
						...
						whenReceived={(results) => <LoadedSearchResults {...{ results }} />}
					/>
				</Layout>
			</AnchoredModal>
		</Layout>
	...
	return (
		<>
			<Layout direction="row" justifyContent="space-between" px={8} py={8}>
				...
				<Button direction="row" alignItems="center" type="button" onClick={(_) => SearchService.Instance.Clear()}><CloseIcon size={24} /></Button>
			</Layout>
			...
			<Layout direction="row">
				...
				<ListOf
					...
					emptyListView={<TranslatedText textKey="SearchResultsEmpty" />}
					renderItem={(item) => (
